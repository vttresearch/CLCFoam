...
#include "unityLewisFourierNoPatchDiffusion.H"
...
unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::unityLewisFourierNoPatchDiffusion
(
    const momentumTransportModel& momentumTransport,
    const thermoModel& thermo
)
:
    unityLewisFourierNoPatchDiffusion
    (
        typeName,
        momentumTransport,
        thermo
...
template<class BasicThermophysicalTransportModel>
const dictionary&
unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::coeffDict() const
{
...
template<class BasicThermophysicalTransportModel>
bool unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::read()
{
    return true;
}
...
unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::q() const
{
...
divq(volScalarField& he) const
{
    ...
    forAll(patches, patchi)
    {
        ...
        {
        // Info << "    divq:Patch " << alphaBf[patchi].patch().name() << " of type " << alphaBf[patchi].patch().type() << endl;
            alphaBf[patchi] *= 0;
        }
    }
...
template<class BasicThermophysicalTransportModel>
tmp<surfaceScalarField>unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::j
(
...
template<class BasicThermophysicalTransportModel>
void unityLewisFourierNoPatchDiffusion<BasicThermophysicalTransportModel>::predict()
{
